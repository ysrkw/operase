    ...
    <form action={login} name="login">
      <fieldset className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input className="rounded border px-4 py-2" id={emailId} name="email" placeholder="john@example.com" type="email" />
        </div>
        <div className="flex flex-col gap-1">
          <label htmlFor={passwordId}>パスワード</label>
          <input className="rounded border px-4 py-2" id={passwordId} name="password" type="password" />
